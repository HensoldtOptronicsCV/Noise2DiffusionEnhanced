...
train_dataset = get_training_data(opt.train_dir_HQ, opt.train_dir_LQ, img_options_train, n2n=opt.train_n2n)
train_loader = DataLoader(dataset=train_dataset, batch_size=opt.batch_size, shuffle=True, 
        num_workers=opt.train_workers, pin_memory=False, drop_last=False)
val_dataset = get_validation_data(opt.val_dir_HQ, opt.val_dir_LQ)
