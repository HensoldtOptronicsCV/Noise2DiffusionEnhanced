...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--nepoch', type=int, default=250, help='training epochs. Base: 250 x 30 000 images (SIDD Dataset) -> adapt accordingly')
        ...
        parser.add_argument('--train_n2n', action='store_true', default=False, help='Training following the Noise2Noise training framework.')
        ...
        parser.add_argument('--train_dir_LQ', type=str, default =None,  help='dir of train data')
        parser.add_argument('--train_dir_HQ', type=str, default ='./datasets/SIDD/train',  help='dir of train data')
        parser.add_argument('--val_dir_LQ', type=str, default ='./datasets/SIDD/val',  help='dir of train data')
        parser.add_argument('--val_dir_HQ', type=str, default ='./datasets/SIDD/val',  help='dir of train data')
